                  ...
                  <div key={punch.id} className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                    <div
                      className={`w-2 h-2 rounded-full mt-2 ${
                        punch.type === "punch_in" ? "bg-green-500" : "bg-blue-500"
                      }`}
                    />
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <p className="font-medium">{employee?.name}</p>
                        <span className="text-xs text-muted-foreground">{punch.timestamp.toLocaleTimeString()}</span>
                      </div>
                      ...
                      {punch.weather && (
                        <div className="flex items-center gap-2 mt-1 text-xs text-muted-foreground">
                          ...
                          {punch.temperature && (
                            <>
                              <Thermometer className="w-3 h-3 ml-2" />
                              {punch.temperature}°C
                            </>
                          )}
                        </div>
                  ...
                  <TableRow key={punch.id}>
                    ...
                    <TableCell>
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{punch.timestamp.toLocaleTimeString()}</p>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      {punch.weather && (
                        <div className="flex items-center gap-1 text-sm">
                          <Cloud className="w-3 h-3" />
                          {punch.weather}
                          {punch.temperature && <span className="ml-1">{punch.temperature}°C</span>}
                        </div>
                      )}
                    </TableCell>
